      ...
      <Routes>
        ...
        <Route path="/dashboard" element={<AdminLayout />}>
          ...
          <Route
            ...
            element={
              <div className="text-left font-bold text-slate-700">
                System Notification Activity Logs
              </div>
            }
          />
          <Route
            ...
            element={
              <div className="text-left font-bold text-slate-700">
                Pharmacy Invoices Master Register
              </div>
            }
          />
          <Route
            ...
            element={
              <div className="text-left font-bold text-slate-700">
                System Parameters Core Settings
              </div>
            }
          />
          <Route
            ...
            element={
              <div className="text-left font-bold text-slate-700">
                Admin Privileges Controller Space
              </div>
            }
          />
          <Route
            ...
            element={
              <div className="text-left font-bold text-slate-700">
                Pharmacy Medical Supply Matrix
              </div>
            }
          />
        </Route>
