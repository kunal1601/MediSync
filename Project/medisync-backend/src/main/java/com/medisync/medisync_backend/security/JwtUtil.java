...
public class JwtUtil {
    ...
    // 256-bit Secret Key for HMAC-SHA algorithms
    private static final String SECRET_KEY_STRING = "MediSyncPharmacySmartBillingSystemSecretKey2026SecureJwtKey!";
    ...
    // 2. Extract Role Claim from Token
    ...
    // 5. Validate Token against Username & Expiration
