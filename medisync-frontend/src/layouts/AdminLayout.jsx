...
const AdminLayout = () => {
  ...
  const menuItems = [
    ...
    { label: 'Settings', path: '/dashboard/settings/profile', icon: Settings, hasSubmenu: true },
          ...
          <nav className="p-4 py-6 space-y-1">
            {menuItems.map((item) => {
              const isActive =
                ...
                (item.path === '/dashboard/manage-admins' &&
                  location.pathname.startsWith('/dashboard/manage-admins'));
